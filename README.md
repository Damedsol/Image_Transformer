...
[![Version](https://img.shields.io/badge/version-1.2.3-blue.svg)](https://github.com/Damedsol/Image_Transformer)
...
4. **Spin Up Optional Services (Docker Compose)**
   ...
   ```bash
   # Development profile (with volumes and hot-reloading)
